...
public class TrackAssignments {
  ...
  public static void main(String[] args) {
    ...
    list.add(new GroupAssignment(LocalDate.of(2025,11,28), "game", "teamMate1, teamMate2"));
    list.add(new Assignment(LocalDate.of(2025,11,1),"java01"));
    list.add(new GroupAssignment(LocalDate.of(2025,11,2), "java02", "teamMate1"));
    list.add(new GroupAssignment(LocalDate.of(2025,11,3), "java03", "teamMate1"));
